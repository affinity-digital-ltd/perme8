defmodule Jarga.Workspaces.Services.EmailAndPubSubNotifier do
  @moduledoc """
  ...
  @behaviour Jarga.Workspaces.Services.NotificationService

  alias Jarga.Accounts.User
  alias Jarga.Workspaces.{Workspace, WorkspaceNotifier}
