defmodule Jarga.Projects.Domain.SlugGenerator do
  @moduledoc """
  Domain service for generating unique project slugs within a workspace.
  ...
  @doc """
  Generates a unique slug from a name within a workspace.

  Accepts a uniqueness checker function as a dependency for testability.
  """
  def generate(name, workspace_id, uniqueness_checker, excluding_id \\ nil) do
    name
    |> Slugy.slugify()
