defmodule Jarga.Agents.Infrastructure.Repositories.ChatMessageRepository do
  @moduledoc """
  ...
  @spec create_message(map(), module()) ::
          {:ok, ChatMessageSchema.t()} | {:error, Ecto.Changeset.t()}
  def create_message(attrs, repo \\ Repo) do
    %ChatMessageSchema{}
    |> ChatMessageSchema.changeset(attrs)
    |> repo.insert()
  end
  ...
  ## Examples
      ...
      {:error, %Ecto.Changeset{}}
  """
  @spec delete_message(ChatMessageSchema.t(), module()) ::
          {:ok, ChatMessageSchema.t()} | {:error, Ecto.Changeset.t()}
  def delete_message(%ChatMessageSchema{} = message, repo \\ Repo) do
    repo.delete(message)
  end
end
