defmodule Jarga.Agents.Infrastructure.Schemas.ChatMessageSchema do
  @moduledoc """
  Infrastructure schema for chat messages within a session.
  ...
  schema "chat_messages" do
    ...
    belongs_to(:chat_session, Jarga.Agents.Infrastructure.Schemas.ChatSessionSchema)
